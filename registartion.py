# Form implementation generated from reading ui file 'registartion.ui'
#
...
"}")
        ...
        self.RegistrationButton = QtWidgets.QPushButton(parent=self.content)
        self.RegistrationButton.setGeometry(QtCore.QRect(20, 290, 361, 49))
        ...
        self.LoginButton.setGeometry(QtCore.QRect(20, 350, 361, 49))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.Title_2.setText(_translate("Form", "Регистрация"))
        self.Title_3.setText(_translate("Form", "Если у вас уже есть аккаунт, нажмите на кнопку авторизации."))
        ...
        self.LoginButton.setText(_translate("Form", "Авторизация"))
